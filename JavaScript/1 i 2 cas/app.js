...
naslov.style = "color: purple; font-size: 42px;";

// TIPOVI PODATAKA //

// Da bismo znali tip promenjljive u JavaScriptu koristimo typeof operator.//
...
// 1.2. Number - predsavlja broj i on moze biti zapisan sa ili bez decimalnog zareza.

console.log(25);
console.log(typeof 25);

// 1.3. BigInt - Brojevi koji prelaze granice obicnih brojeva.
console.log(BigInt(4567890987654567890));
console.log(typeof BigInt(4567890987654567890));
...
// 1.5. Undefined - Promenljiva koja je definisana, ali joj nije dodeljena vrednist undefined i tip takodje undefined.

var a;
console.log(a);
console.log(typeof a);

// 1.6. null - Predstavlja nekorektnu vrednist ili vrednost koja (za sada) ne postoji.

var a = null;
console.log(a);
console.log(typeof a);

// 1.7. Symbol - Tip podataka za skladistenje anonimnih podataka i unikatnih vrednosti.
...
// Za skladistenje vise vrednost ili kompleksnih vrednosti se koriste primitivni tipovi podataka.
// Svaka promenljiva koja nije primitivnog tipa je tipa object u JS.
